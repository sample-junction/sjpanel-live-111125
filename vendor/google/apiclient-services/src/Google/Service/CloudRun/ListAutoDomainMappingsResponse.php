...
class Google_Service_CloudRun_ListAutoDomainMappingsResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  public $apiVersion;
  protected $itemsType = 'Google_Service_CloudRun_AutoDomainMapping';
  ...
  /**
   * @param Google_Service_CloudRun_AutoDomainMapping
   */
