    ...
    "backend" => [
        "access" => [
            ...
            "users" => [
                ...
                "cant_deactivate_self" => "You cannot do that to yourself.",
                "cant_delete_admin" => "You cannot delete the super administrator.",
                "cant_delete_own_session" => "You cannot delete your own session.",
                "cant_delete_self" => "You cannot delete yourself.",
                "cant_restore" => "This user is not deleted so it can not be restored.",
                "cant_unconfirm_admin" => "You cannot un-confirm the super administrator.",
                "cant_unconfirm_self" => "You cannot un-confirm yourself.",
    ...
    "frontend" => [
        "auth" => [
            "confirmation" => [
                ...
                "confirm" => "Confirm your account!",
                "confirm1" => "Complete Your  Account Registration and Earn",
                "confirm2" => "Points",
 
                 "template_1_sub_1" => "Earn $",
                //"template_1_sub_1" => "Important",
                 "template_1_sub_2" => "Welcome Back Reward!",
                //"template_1_sub_2" => "Removal of Duplicate E-Mail",
 
                "confirm_doi_sub1"=>"Opportunity To Earn £1.12 - Complete your Registration",
                "confirm_doi_sub2"=>"- Complete your Registration ", 
                "deleteconfirm" => "Confirmation Required: Deactivation Request for Your SJ Panel Account",
                "userinfodeleteconfirm" => "Confirmation Required: Deletion of Your Personal Information",
                "deletewelcome" => "Confirmation of SJ Panel Account Deactivation",
                "userinfodeletewelcome" =>"Confirmation of Personal Information Deletion",
                ...
                "pending" => "Your account still in process. Please click the link sent in your registered email to complete your registration.",
            ...
            "deactivated" => "Your account has been deactivated, please reach our support team.",
