...
return [
    "backend" => [
        "access" => [
            "roles" => [
                "already_exists" => "Ese rol ya existe. Por favor, elija un nombre diferente.",
            ...
            "users" => [
                ...
                "session_wrong_driver" => "El controlador de la sesión debe configurarse en la base de datos para utilizar esta función.",
                "social_delete_error" => "Se produjo un problema al eliminar la cuenta social del usuario.",
        ...
        "auth" => [
            "confirmation" => [
                ...
                //"confirm" => "¡Confirme su cuenta!",
                 "confirm" => "¡Confirme su cuenta!",
                 "confirm1" => "Complete el registro de su cuenta y gane",
                 "confirm2" => "puntos",
                 "confirm_doi_sub1"=>"Oportunidad de Ganar $1.40 - Complete su Registro ",
                "confirm_doi_sub2"=>"Puntos - Confirma tu cuenta",
                "deleteconfirm" => "Se requiere confirmación: Solicitud de desactivación para su cuenta del panel SJ",
                "userinfodeleteconfirm" => "Se requiere confirmación: eliminación de su información personal",
                "deletewelcome" => "Confirmación de la desactivación de la cuenta del panel SJ",
                "userinfodeletewelcome" =>"Confirmación de la eliminación de información personal",
                ...
                "resend" => "Tu cuenta no está confirmada. Haga clic en el enlace de confirmación en su correo electrónico o <a href=\":url\"> haga clic aquí </a> para reenviar el correo electrónico de confirmación.",
                "resent" => "Se ha enviado un nuevo correo electrónico de confirmación a la dirección registrada.",
                "success" => "Su cuenta ha sido confirmada con éxito!"
            ],
            "deactivated" => "Su cuenta ha sido desactivada, llegue a nuestro equipo de soporte.",
