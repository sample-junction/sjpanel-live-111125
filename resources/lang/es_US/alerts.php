...
return [
    "backend" => [
        "roles" => [
            ...
            "setup" => "El rol fue configurado con éxito.",
        ...
        "users" => [
            ...
            "confirmation_email" => "Se ha enviado un nuevo correo electrónico de confirmación a la dirección registrada.",
            ...
            "social_deleted" => "Cuenta social eliminada exitosamente",
    ...
    "frontend" => [
        "contact" => [
            "sent" => "Su información fue enviada con éxito. Responderemos al correo electrónico proporcionado tan pronto como podamos."
        ]
    ]
];
