...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="rounded-5 p-2 bg-white shadow">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Preston Parsons</span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">250406370018</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$10</span></span>
                    <br>
                    <span class="small" style="font-weight:600">City & State : <span style="font-weight:400">Pictou, NS</span></span>
                ...
                <div class="mt-3 rounded-5 p-2 shadow bg-light">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Nessa Lee</span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">250327270098</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$15</span></span>
                    <br>
                    <span class="small ms-2" style="font-weight:600">City & State : <span style="font-weight:400">Toronto, ON</span></span>
                    <span class="small ms-2" style="font-weight:600">Redemption status : <span style="font-weight:400"> Redeemed on 5/20/2025</span></span>
                ...
                <div class="mt-3 rounded-5 p-2 bg-white shadow">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Pieter van der Plas</span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">241124470004</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$20</span></span>
                    <br>
                    <span class="small ms-2" style="font-weight:600">City & State : <span style="font-weight:400">Edmonton, AB</span></span>
                    <span class="small ms-2" style="font-weight:600">Redemption status : <span style="font-weight:400">Redeemed on 5/20/2025</span></span>
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <p class="text-primary mb-1"><span class="fw-bold">Prize Amount :</span> <span>7,400 Points ( $10)</span></p>
            ...
            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span> 1539</span></p>
            ...
            <div class="p-4 rounded-4 text-start mt-1 res-box hid" id="profileAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">Name :</span> <span>Noelle Hartz</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>250507010002</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Stoney Creek, ON</span></p>
...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <p class="text-primary mb-1"><span class="fw-bold">Prize Amount :</span> <span>11,100 Points ( $15)</span></p>
            ...
            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span>10956</span></p>
            ...
            <div class="p-4 rounded-3 text-start mt-1 res-box hid" id="surveyAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">Name :</span> <span>Jaime Parker</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>250329300090</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Woodstock, ON</span></p>
...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <p class="text-primary mb-1"><span class="fw-bold">Prize Amount :</span> <span>14,800 Points ( $20)</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Attempted most number of surveys in May, 2025</span></p>


            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span>89651</span></p>
            ...
            <div class="p-4 rounded-4 text-start mt-1 res-box hid" id="activeAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">Name :</span> <span>Mayda Brandolino</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>250210510001</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Mississauga, ON</span></p>
                <!-- <p class="text-dark mb-1"><span class="fw-bold">Price Amount :</span> <span>$10</span></p> -->
