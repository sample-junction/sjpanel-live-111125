  ...
  <div id="container"><!-- main container starts-->
    <div id="wrapp"><!-- main wrapp starts-->
        <nav class="navbar navbar-expand-lg navbar-dark  static-top">
          <div class="container Nav-div" style="text-align: center !important; display:flex !important; justify-content: center !important;">
    ...
    <div class="container mt-5 pt-5">
        ...
        <div class="row shadow" style="border-radius: 20px;">
            ...
            <div class="col-6 text-center pt-5 pb-5 ps-5 pe-5">
                ...
                <p class="h4 text-primary mb-4">***Your Information Will Be Kept Under Full Privacy.***</p>
					...
					<form id="myform" action="{{ route('frontend.video.upload') }}" method="POST" enctype="multipart/form-data">
					@csrf
                    ...
                    <div class="drop-zone">
                        ...
                        <p class="mt-2 mb-0 text-dark drop-zone__prompt2 mt-4" style="font-size: 15px;">Select a file or drag and drop here</p>

                        <p class="mt-1 text-secondary drop-zone__prompt3" style="opacity:0.7; font-size: 15px;">JPG, PNG or Video file size no more than 10 MB</p>
