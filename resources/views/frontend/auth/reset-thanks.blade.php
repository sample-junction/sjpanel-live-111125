        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-xl-12">
            ...
            <div class="col-lg-6 div_m_t">
                ...
                <img src="{{ asset('img/thank reset pass.png')}}" class="image_center" />
                <h4 class="mb-4 text_margin_style Thank_text_h1" style="color: black !important;">{{__('frontend.index.contact_us.reset_pass_1')}}</h4>
                <p class="small mb-0 p_open" style="color: black !important;">{{__('frontend.index.contact_us.reset_pass_2')}}</br>{{__('frontend.index.contact_us.reset_pass_3')}}
                  <a href="{{url('/')}}/login">{{__('frontend.modes.email_auth.button')}}</a>.
                </p>
