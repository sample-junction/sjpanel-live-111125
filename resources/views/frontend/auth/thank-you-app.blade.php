...
gtag('event', 'conversion', {'send_to': 'AW-11352794455/bdbQCJquuOYYENfKt6Uq'});
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-xl-12">
            ...
            <div class="col-lg-6 div_m_t">
                ...
                <h4 class="mb-4 text_margin_style Thank_text_h1">{{__('frontend.mobile_app.thanks_1')}}</h4>
                <p class="small mb-0 p_open" style="color: black !important;">{{__('frontend.mobile_app.thanks_2')}}<br/>
                {{__('frontend.mobile_app.thanks_3')}}<br/>{{__('frontend.mobile_app.thanks_4')}}</p>
              </div>
            </div>
          </div>
        </div>
