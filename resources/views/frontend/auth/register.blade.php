        ...
        <div class="col-xl-12">
          <div class="card rounded-3 text-black">
            <div class="row g-0" width="25px">
              ...
              <div class="row" id="reg_with" style="margin-top:-21px !important">
                <div class="col-4">
                  <hr id="hr-1" />
                </div>
                <div class="col-4">
              ...
              <div class="row" id="register_with" style=" margin-top: 20px!important; padding:15px">
...
@if (config('access.captcha.registration'))
  {!! NoCaptcha::renderJs() !!}
@endif
<script type="text/javascript" id="forensic_script_id" src="https://api-cdn.dfiq.net/scripts/forensic-v6.0.1.min.js" data-key="29109E607D0B6E11DE0B966F50EA617A-5004-1" data-nc></script>
