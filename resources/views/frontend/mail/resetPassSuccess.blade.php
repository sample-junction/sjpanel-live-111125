...
@endphp
    ...
    <div style="max-width: 560px; margin: 30px auto; background-color: #f4faff; border-radius: 13px; text-align: center; overflow: hidden;">
        <img  src="{{asset('img/frontend/reset_mail.png')}}" alt="" style="height: 81px; width: 81px; margin-top: 30px; margin-bottom: 10px;">
        <p style="font-size: 24px; line-height: 32px; font-weight: bold; margin: 0; padding: 0 20px;">{{__('frontend.otp_mail.greetings')}} {{$user->first_name}},</p>
        <!-- <p style="color: #595959; font-size: 16px; margin: 10px 0; padding: 0 20px;">{{__('frontend.otp_mail.header')}}&nbsp;<strong></strong></p> -->
        <p style="color: #595959; font-size: 16px; margin: 0; padding: 0 20px; margin-bottom:10px; margin-top:10px;">{{__('frontend.otp_mail.body_success_password')}} 
        @if($user->locale!='hi_IN') 
        <span> <a style="text-decoration:none;font-size:16px;padding:0px;margin:0px;color:rgba(16, 128, 208, 1)" href="mailto: support@sjpanel.com">support@sjpanel.com.</a></span>
        @endif
    </p><br>
    </div>
   ...
   <p style="font-size:16px;line-height:20px;">{{__('frontend.welcome_mail.new_footer')}}</p>
   </div>
