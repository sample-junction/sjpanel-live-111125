            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:20px 10px;">
                            <img src="{{asset('img/img_email/Confirmation_Mail.png')}}" alt="" style="height:81px;width:81px;margin-top:20px;">
                            <p style="font-size:30px;line-height:20px;font-weight:bold;">{{__('inpanel.mail.invitation.invite_freind_content_1')}} {{$user->first_name}},</p>

                           
                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;width:auto;margin-top:20px!important;margin-bottom:20px!important;"> {{__('inpanel.mail.invitation.profileprompt_content_1')}} <br> {{__('inpanel.mail.invitation.profileprompt_content_2')}} {{$profile_point['value']}} {{__('inpanel.mail.invitation.profileprompt_content_3')}}</p>
                           

                            <div style="margin-left:20%;text-align:left;">
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px;text-align:left;line-height: 24px;margin-top:10px!important;"> {{__('inpanel.mail.invitation.profileprompt_content_4')}}<br><br>{{__('inpanel.mail.invitation.profileprompt_content_5')}}<br>{{__('inpanel.mail.invitation.profileprompt_content_6')}}<br>{{__('inpanel.mail.invitation.profileprompt_content_7')}}</p>
                            </div>
        

                             <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;width:auto;margin-top:10px!important;margin-bottom:10px!important;">{{__('inpanel.mail.invitation.profileprompt_content_8')}}</p> 

                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;width:auto;margin-top:10px!important;margin-bottom:10px!important;">{{__('inpanel.mail.invitation.profileprompt_content_9')}}</p> 
                         
                            <a href="{{route('frontend.auth.login',['prompt_id'=>true])}}" target="_blank" style="width:308px; height:45px;background-color:rgba(16, 128, 208, 1);border-radius:5px;text-decoration:none;font-size:16px;line-height:40px;color:white;font-weight:bold;padding:13px 70px;margin-bottom:40px!important;">{{__('inpanel.mail.invitation.profileprompt_content_10')}}</a>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;padding: -20px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin:auto;width:560px;height:96px;background-color:rgba(255, 251, 243, 1); border-radius:13px; text-align: center;padding:1px 13px;">
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px;line-height:24px;padding:15px 0px;justify-content:center;">{!!__('inpanel.mail.invitation.profileprompt_content_11')!!}</p> 
                        </div>
                    </td>
                </tr>
