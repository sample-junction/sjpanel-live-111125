...
<body style="background-color:white; font-family: 'Roboto', sans-serif;">
    ...
    <div style="width:90%;margin:30px auto;background-color:rgba(244, 250, 255, 1); border-radius:13px; text-align:center;">
        ...
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; ">  {{--__('strings.emails.auth.confirmation.tmp_1_details_sub1')}}{{__('strings.emails.auth.confirmation.tmp_3_details_sub2')--}}Greetings of the day!</p><br>
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; "> {{-- {!!__('strings.emails.auth.confirmation.tmp_3_details_2')!!} <b>${{$get_reffer_point}}.</b> {{__('strings.emails.auth.confirmation.tmp_2_details_3')}} --}}Our records show that there are two duplicate IDs associated with your account.</p><br>        
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 50px; padding-right: 30px; "> {{-- {!!__('strings.emails.auth.confirmation.tmp_3_details_4')!!} <br>  {!!__('strings.emails.auth.confirmation.tmp_3_details_5')!!} --}}As per our current policy, we have deleted one of the duplicate IDs (Panellist ID: 231027560001).</p><br> 
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; "> {{-- {!!__('strings.emails.auth.confirmation.tmp_1_details_6')!!} --}}Going forward, we request you to kindly use your original Panellists ID: 231027480002 for all interactions and transactions with our team.</p><br> 
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; "> We understand that this may cause some inconvenience and we apologize for any disruption this may have caused. However, this corrective action is crucial to maintain the integrity of our database and provide you with a better survey experience.</p><br> 
    @php
        if($user->is_social == 1){
   ...
   <div style="width:90%;height:114px;margin:40px auto; border:1px solid white;background-color:rgba(255, 251, 243, 1); border-radius:13px; text-align:center; padding:30px auto; box-sizing:border-box; padding:0px;">
      <p style="font-size:16px;margin-top:30px;line-height:18px;padding:-5px; margin-left: 20px;margin-right: 20px;">{{--__('frontend.welcome_mail.com_details_7')--}}In case you have any queries, you can always reach out to us by raising a ticket from “Panelist Support” page or send us an email at <a style="text-decoration:none;font-size:16px;padding:0px;margin:0px;color:rgba(16, 128, 208, 1)" href="mailto: support@sjpanel.com">support@sjpanel.com.</a></p>
   </div>
