...
<body style="background-color:white; font-family: 'Roboto', sans-serif;">
    ...
    <div style="max-width: 560px; margin: 30px auto; background-color: #f4faff; border-radius: 13px; text-align: center; overflow: hidden;">
        ...
        <p style="color: #595959; font-size: 16px; margin: 0; padding: 0 20px; margim-top:5px;">{{__('strings.emails.auth.confirmation.person_delete')}}</p>
        <p style="color: #595959; font-size: 16px; margin: 10px 0; padding: 0 20px;"> {{__('strings.emails.auth.confirmation.person_delete1')}}
        </p>
   ...
   <!-- Body_part_2 -->
     <div style="width:560px;height:114px;margin:40px auto; border:1px solid white;background-color:rgba(255, 251, 243, 1); border-radius:13px; text-align:center; padding:30px auto; box-sizing:border-box;">
       <p style="font-size:16px;margin-top:30px;line-height:15px;padding:-5px; padding:10px;">{{__('strings.emails.auth.confirmation.person_delete2')}}<a style="text-decoration:none;font-size:16px;padding:0px;margin:0px;color:rgba(16, 128, 208, 1)" href="mailto: support@sjpanel.com">support@sjpanel.com</a>.{{__('strings.emails.auth.confirmation.person_delete3')}}</p>
   </div>
