...
<body style="background-color:white; font-family: 'Roboto', sans-serif;">
    ...
    <div style="width:90%;margin:30px auto;background-color:rgba(244, 250, 255, 1); border-radius:13px; text-align:center;">
        ...
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; ">  {{__('strings.emails.auth.confirmation.tmp_1_details_sub1')}}{{__('strings.emails.auth.confirmation.tmp_1_details_sub2')}}</p><br>
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; ">  {!!__('strings.emails.auth.confirmation.tmp_1_details_2')!!} <b>${{$get_reffer_point}} gift coupon.</b> {{__('strings.emails.auth.confirmation.tmp_1_details_3')}}</p><br>        
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 50px; padding-right: 30px; ">  {!!__('strings.emails.auth.confirmation.tmp_1_details_4')!!} <br>  {!!__('strings.emails.auth.confirmation.tmp_1_details_5')!!} </p><br> 
    ...
    @endphp     
      <a href="{{$route}}" style="display: inline-block; padding: 10px 20px; margin: 15px 0; font-size: 16px; font-weight: bold; text-align: center; text-decoration: none; color: #ffffff; background-color: #006bde; border-radius: 6px;"
        target="_blank"> {{__('strings.emails.auth.confirmation.tmp_1_confirm_button')}}</a>

    {{-- <p style="color:rgba(89, 89, 89, 1); font-size:16px;">{{__('frontend.welcome_mail.com_details_5')}} </p><br>    --}}

    
    <p style="color:rgba(89, 89, 89, 1); font-size:16px; margin:0px; padding-left: 30px; padding-right: 30px; ">  {!!__('strings.emails.auth.confirmation.tmp_1_details_7')!!} </p><br>
   ...
   <div style="width:100%; border-top: 1px solid gainsboro;border-bottom: 1px solid gainsboro; margin-top:40px;">
    <div style="width:90%; margin:auto;background-color:white;  text-align:center; padding:10px;" >  
        ...
        <div style="margin:auto;width:100%;height:56px;background-color:rgba(16, 128, 208, 1); margin-bottom:0px; margin-top:10px;">
