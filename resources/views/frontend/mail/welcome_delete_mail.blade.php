...
<body style="background-color:white; font-family: 'Roboto', sans-serif;">
    ...
    <div style="max-width: 560px; margin: 30px auto; background-color: #f4faff; border-radius: 13px; text-align: center; overflow: hidden;">
        ...
        <p style="font-size: 24px; line-height: 32px; font-weight: bold; margin: 0; padding: 0 20px;margin-left:20px; margin-right:20px;">{{__('strings.emails.auth.confirmation.dear')}} {{$first_name}},</p>
        <p style="color: #595959; font-size: 16px; margin: 0; padding: 0 20px; margim-top:5px;margin-left:20px; margin-right:20px;">{{__('frontend.welcome_mail.com_details_3')}}</p>
        <p style="color: #595959; font-size: 16px; margin: 10px 0; padding: 0 20px;margin-left:20px; margin-right:20px;">  {{__('frontend.welcome_mail.com_details_4')}}
        </p>
        <p style="color: #595959; font-size: 16px; margin: 0; padding: 0 20px; margin-bottom:10px;margin-left:20px; margin-right:20px;">{{__('frontend.welcome_mail.com_details_5')}} <a style="text-decoration: none;" href = "mailto: support@sjpanel.com">support@sjpanel.com</a>,{{__('frontend.welcome_mail.com_details_6')}}</p>
    </div>
