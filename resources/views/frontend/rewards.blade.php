...
<div class="row" style="background: #ececec;">
   ...
   <!-- <div class="col text-center">
    ...
    <div class="col-12 p-0">
        ...
        <img src="{{asset('img/bannerNewOctober.png')}}" alt="legitimate paid online surveys" class="img-fluid">
    ...
    <div class="row mt-4 ps-4 pe-4">
        ...
        <div class="col-3 d-none d-lg-block">
            ...
            <div class="shadow rounded-3 ps-4 pe-4 pt-3 pb-3 info-box">
                ...
                <span class="me-4" style="font-size: 52px; color:#CCE8FF">1</span><span><img src="{{asset('images/arrow1.png')}}" alt="get paid to do surveys online" class="img-fluid" style="transform: translateY(-14px);"></span>
        ...
        <div class="col-3 d-none d-lg-block">
            ...
            <div class="shadow rounded-3 ps-4 pe-4 pt-3 pb-3 info-box">
                ...
                <span class="me-4" style="font-size: 52px; color:#FCD7D7">2</span><span><img src="{{asset('images/arrow2.png')}}" alt="get paid to take surveys online" class="img-fluid" style="transform: translateY(-14px);"></span>
        ...
        <div class="col-3 d-none d-lg-block">
            ...
            <div class="shadow rounded-3 ps-4 pe-4 pt-3 pb-3 info-box">
                ...
                <span class="me-4" style="font-size: 52px; color:#E2E0FF">3</span><span><img src="{{asset('images/arrow3.png')}}" alt="online surveys that pay instantly" class="img-fluid" style="transform: translateY(-14px);"></span>
    ...
    <div class="col-12 d-lg-none">
        ...
        <section class="regular-2 slider" style="margin:0 !important;">
            ...
            <div class="border rounded-3 p-4 mob-card">
                ...
                <span class="me-4" style="font-size: 52px; color:#CCE8FF">1</span><span><img src="{{asset('images/arrow1.png')}}" alt="online surveys and get paid" class="img-fluid" style="transform: translateY(-14px);"></span>
            ...
            <div class="border rounded-3 p-4 mob-card">
                ...
                <span class="me-4" style="font-size: 52px; color:#FCD7D7">2</span><span><img src="{{asset('images/arrow2.png')}}" alt="real online surveys for money" class="img-fluid" style="transform: translateY(-14px);"></span>
            ...
            <div class="border rounded-3 p-4 mob-card">
                ...
                <span class="me-4" style="font-size: 52px; color:#E2E0FF">3</span><span><img src="{{asset('images/arrow3.png')}}" alt="real cash surveys online" class="img-fluid" style="transform: translateY(-14px);"></span>
...
<div id="filter-content-data" class="container-fluid ps-5 pe-5 hid" data-sr="f-award">
    ...
    <div class="row">
        ...
        <p class="h4 text-custom fw-bold m-0 mb-3">September Month Winners</p>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="rounded-5 p-2 bg-white shadow">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Itsaso Phebus </span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">240925020003</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$10</span></span>
                    <br>
                    <span class="small" style="font-weight:600">City & State : <span style="font-weight:400">Jacksonville, FL</span></span>
                    <span class="small ms-2" style="font-weight:600">Redemption status : <span style="font-weight:400">Redeemed on 10/24/2024</span></span>
                ...
                <div class="mt-3 rounded-5 p-2 shadow bg-light">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Connie Thowson </span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">240221470003</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$20</span></span>
                    <br>
                    <span class="small ms-2" style="font-weight:600">City & State : <span style="font-weight:400">Sahuarita, AZ</span></span>
                ...
                <div class="mt-3 rounded-5 p-2 bg-white shadow">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Quentin Jellum  </span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">240816270001</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$30</span></span>
                    <br>
                    <span class="small ms-2" style="font-weight:600">City & State : <span style="font-weight:400">New York, NY</span></span>
                    <span class="small ms-2" style="font-weight:600">Redemption status : <span style="font-weight:400"> Redeemed on 10/16/2024</span></span>
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <img src="{{asset('img/g119.png')}}" alt="money through surveys" class="img-fluid mb-3" width="150px">
            
            <p class="text-primary lead fw-bold mb-2">Profile Prodigy</p>

            <p class="text-primary mb-1"><span class="fw-bold">Price Amount :</span> <span>$10 Gift Coupon</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Those who have completed all 8 profiles in October 2024</span></p>
            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span> 1758</span></p>
            ...
            <div class="p-4 rounded-4 text-start mt-1 res-box hid" id="profileAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">First Name :</span> <span>Desarey Hutchison</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>241013550002</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Englewood, NJ</span></p>
...
<div id="filter-content-data" class="container-fluid ps-5 pe-5 hid" data-sr="s-award">
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <img src="{{asset('img/g118.png')}}" alt="answer surveys and earn" class="img-fluid mb-3" width="150px">
            
            <p class="text-primary lead fw-bold mb-2">Survey Superstar</p>

            <p class="text-primary mb-1"><span class="fw-bold">Price Amount :</span> <span>$20 Gift Coupon</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Completed the maximum surveys in October 2024</span></p>
            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span>10,382</span></p>
            ...
            <div class="p-4 rounded-3 text-start mt-1 res-box hid" id="surveyAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">First Name :</span> <span>Birgitta Cagan</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>240613010002</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Levittown, PA</span></p>
                <!-- <p class="text-dark mb-1"><span class="fw-bold">Price Amount :</span> <span>$10</span></p> -->
...
<div id="filter-content-data" class="container-fluid ps-5 pe-5 hid" data-sr="t-award">
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <img src="{{asset('img/g120.png')}}" alt="get paid for answering surveys" class="img-fluid mb-3" width="150px">
            
            <p class="text-primary lead fw-bold mb-2">Most Active Panelist</p>

            <p class="text-primary mb-1"><span class="fw-bold">Price Amount :</span> <span>$30 Gift Coupon</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Attempted the maximum surveys in October 2024</span></p>

            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span>84,356</span></p>
            ...
            <div class="p-4 rounded-4 text-start mt-1 res-box hid" id="activeAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">First Name :</span> <span>Jennifer Carney</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>240804550019</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Massillon, OH</span></p>
                <!-- <p class="text-dark mb-1"><span class="fw-bold">Price Amount :</span> <span>$10</span></p> -->
