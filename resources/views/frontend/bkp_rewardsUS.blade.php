...
<div class="row" style="background: #ececec;">
   ...
   <!-- <div class="col text-center">
    ...
    <div class="col-12 p-0">
        ...
        <img src="{{asset('img/JanBanner_reward_Page.png')}}" alt="banner" class="img-fluid">
...
<div class="row">
    ...
    <div class="row">
        ...
        <p class="h4 text-custom fw-bold m-0 mb-3">December Month Winners</p>
        ...
        <div class="row">
          ...
          <div class="col-12">
                ...
                <div class="rounded-5 p-2 bg-white shadow">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Joy Gordon</span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">241212470003</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$10</span></span>
                    <br>
                    <span class="small" style="font-weight:600">City & State : <span style="font-weight:400">Flemington, NJ</span></span>
                    <span class="small ms-2" style="font-weight:600">Redemption status : <span style="font-weight:400">Redeemed on 1/17/2025</span></span>
                ...
                <div class="mt-3 rounded-5 p-2 shadow bg-light">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Misty Courtney</span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">241105050019</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$15</span></span>
                    <br>
                    <span class="small ms-2" style="font-weight:600">City & State : <span style="font-weight:400">Beaumont, MS</span></span>
                    <span class="small ms-2" style="font-weight:600">Redemption status : <span style="font-weight:400">Redeemed on 1/20/2025
                ...
                <div class="mt-3 rounded-5 p-2 bg-white shadow">
                    ...
                    <span class="small" style="font-weight:600">Name : <span style="font-weight:400">Belinda Brister</span></span>
                    <span class="small" style="font-weight:600">Panelist Id : <span style="font-weight:400">240429510016</span></span>
                    <span class="small ms-2" style="font-weight:600">Amount : <span style="font-weight:400">$20</span></span>
                    <br>
                    <span class="small ms-2" style="font-weight:600">City & State : <span style="font-weight:400">Riverside, CA</span></span>
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <p class="text-primary mb-1"><span class="fw-bold">Prize Amount :</span> <span>$10 Gift Coupon</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Those who have completed all 8 profiles in January, 2025</span></p>
            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span> 1433</span></p>
            ...
            <div class="p-4 rounded-4 text-start mt-1 res-box hid" id="profileAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">Name :</span> <span>Viola Pol</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>250126060057</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Imperial Beach, CA</span></p>
...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <p class="text-primary mb-1"><span class="fw-bold">Prize Amount :</span> <span>$15 Gift Coupon</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Those who have completed the surveys in January, 2025</span></p>
            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span>10099</span></p>
...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="col text-center mt-4">
            ...
            <p class="text-primary mb-1"><span class="fw-bold">Prize Amount :</span> <span>$20 Gift Coupon</span></p>
            <p class="text-primary mb-1"><span class="fw-bold">Requirement :</span> <span>Attempted most number of surveys in January, 2025</span></p>

            <p class="text-primary mb-3"><span class="fw-bold">Total Nominations :</span> <span>83049</span></p>
            ...
            <div class="p-4 rounded-4 text-start mt-1 res-box hid" id="activeAward" style="width: 300px; margin-left: 50%; transform: translateX(-50%); border: 2px solid black;">
                ...
                <p class="text-dark mb-1"><span class="fw-bold">Name :</span> <span>Lois Heskamp</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">Panelist ID :</span> <span>240405150008</span></p>
                <p class="text-dark mb-1"><span class="fw-bold">City & State :</span> <span>Loveland, OH</span></p>
                <!-- <p class="text-dark mb-1"><span class="fw-bold">Price Amount :</span> <span>$10</span></p> -->
