...
<div class="navbar-wrapper">
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll" style="width:250px;">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                    <span class="sr-only">{{__('frontend.nav.static.title')}}</span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button>
                <a class="navbar-brand" href="{{ route('frontend.index') }}"><img alt="earn by survey online" style="width: 80%;" src="{{ asset('/images/logo.png') }}" class="logo-name"> </a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a class="page-scroll" href="#page-top">{{__('frontend.nav.static.heading_1')}}</a></li>
                    <li><a class="page-scroll" href="#features">{{__('frontend.nav.static.heading_2')}}</a></li>
                    <li><a class="page-scroll" href="#testimonials">{{__('frontend.nav.static.heading_3')}}</a></li>
		    <li><a class="page-scroll" href="/pages/rewards">{{__('frontend.nav.static.heading_5')}}</a></li>
		    <li><a class="page-scroll" href="/blog">{{__('frontend.nav.static.heading_6')}}</a></li>
                    <li><a class="page-scroll" href="#contact">{{__('frontend.nav.static.heading_4')}}</a></li>
                    @auth
                    ...
                    @else
                        <li><a href="{{route('frontend.auth.login')}}">{{__('frontend.nav.static.link.login')}}</a></li>
                        @if (config('access.registration'))
                            <li class="hideonmobile getproposal ga-event-proposal-button-header menu-item menu-item-type-custom menu-item-object-custom">
                                <a href="{{route('frontend.auth.register')}}" class="getStarted btn btn-primary">{{__('frontend.nav.static.link.join_now')}}</a>
                            </li>
                        @endif
                    @endauth
                    ...
                    <li class="dropdown language_dropdown" id="country_language_nav">                        
                        ...
                        <ul class="dropdown-menu dropdown-menu-right all_language_list" aria-labelledby="language-button" style="min-width:120px;">
                            ...
                            <div class="col-md-61" style="width:auto; margin-left: 10px;">
                                {{--US--}}
