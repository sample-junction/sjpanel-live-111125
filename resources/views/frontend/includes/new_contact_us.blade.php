        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-start p-5 contact-round-1" style="background: #0F0E2C;">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col text-start p-0">
                        ...
                        <p class="text-light" style="font-size: 17px;">Suite 117, 9131 Keele St, Concord, ON L4K 0G7</p>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-start p-4 p-md-5 position-relative contact-round-2">
                ...
                <div>
                    ...
                    <button class="g-recaptcha btn btn-primary ps-5 pe-5 pt-2 pb-2" type="submit" style="font-size: 17px; font-weight: 500;" onclick="onSubmitData()"
