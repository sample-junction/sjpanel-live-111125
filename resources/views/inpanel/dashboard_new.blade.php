                    ...
                    <div class="row" style="transform: translateY(-5px);">
                        ...
                        <div class="col">
                            ...
                            <p class="lead mt-3 mb-3">
                                ...
                                @elseif(auth()->user()->locale == 'fr_CA' || auth()->user()->locale=='hi_IN')
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col text-end">
                            ...
                            <span class="pull-right survey_list">
                                <a class="btn btn-primary btn-lg survey-btn" style="font-size:18px" href="@if(Route::has('inpanel.survey.execute.show')){{route('inpanel.profiler.show', ['survey_id' => $detailed_profile_survey->_id])}}@endif" id="tke_sry_but">{{__('inpanel.survey.index.link_take_survey')}}</a>
                ...
                <div class="row">
                    ...
                    <div class="col text-end">
                        ...
                        <span class="pull-right survey_list">
                            ...
                            <a class="btn btn-primary btn-lg survey-btn" style="font-size:18px" href="@if(Route::has('inpanel.survey.execute.show')){{route('inpanel.survey.execute.show', ['survey_id' => $detailed_profile_survey->id])}}@endif" id="tke_sry_but" target="_blank">{{__('inpanel.survey.index.link_take_survey')}}</a>
                            @else
        ...
        */
        ...
        $(document).on('click', 'a#survey', function(e) {
            ...
            swal({
                ...
                if (result.value === true) {
                    var urlTemplate = "{{ route('inpanel.survey.execute.show', ['survey_id' => ':id']) }}";
                    var surveyId = active_survey_id;
                    var url = urlTemplate.replace(':id', surveyId);
        ...
        document.querySelectorAll('.remove-pop-up-survey').forEach((item) => {
           ...
           document.querySelectorAll('.remove-reward-popup').forEach((item) => {
            item.addEventListener('click', () => {
                ...
                document.querySelector('#tourModal').style.zIndex = 1054;
                document.querySelector('#redeemRequestModal').style.zIndex = 1052;
            });
        });
