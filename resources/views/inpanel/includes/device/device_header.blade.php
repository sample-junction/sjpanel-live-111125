                            ...
                            @if(count($user_notifications) > 0)
                                ...
                                @if($count_live > 0)
                                    ...
                                    <li class="border-bottom p-2"><a class="dropdown-item" href="{{$url}}">
                                            ...
                                            <span class="pe-2 not-li-size" style="font-size: 10px;">{{-- <img @if(Auth::user()->image_url) src="{{asset("img/".Auth::user()->image_url)}}" @else  src="{{asset("vendor/img/rewards/profile_default.png")}}" @endif  alt="user" width="30px" class="img-fluid me-2">--}}{{$count_live}}{{$count_live>1?__('frontend.notification_txt.surveys_assigned'): __('frontend.notification_txt.survey_assigned')}}</span></br>
