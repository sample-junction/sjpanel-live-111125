...
@push('after-scripts')
    ...
    <script>
        ...
        * */
        ...
        $welcome = shepherd.addStep('Password', {
            title: "<i class=\"em em-gift\"></i>&nbsp;"+"{{__('inpanel.page_guide.password.password_update.title')}}",
            text: "{{__('inpanel.page_guide.password.password_update.details')}}",
        ...
        $finish =  shepherd.addStep('Password', {
            title: "<i class=\"em em-gift\"></i>&nbsp;"+"{{__('inpanel.page_guide.password.update_form.title')}}",
            text: "{{__('inpanel.page_guide.password.update_form.details')}}",
        ...
        function changeTourOption()
        {
            ...
            var ajaxObj = axios.get("{{route('inpanel.change.tour.selection','preferences.password')}}",headers);
        }
