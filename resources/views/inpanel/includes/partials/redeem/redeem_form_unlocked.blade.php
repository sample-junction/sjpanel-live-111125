                    ...
                    <div class="row fixedContainer">
                        ...
                        @foreach($gift_cards as $card)
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 gift_card_details">
                                ...
                                @endphp
                                <input type="radio" name="giftcard" id=" {{\Illuminate\Support\Str::snake($card->code)}}" value="{{$card->code}}" class="input-hidden" /><label for="{{\Illuminate\Support\Str::snake($card->code)}}"> 
                                    <img
                                        src="{{asset($source)}}"
