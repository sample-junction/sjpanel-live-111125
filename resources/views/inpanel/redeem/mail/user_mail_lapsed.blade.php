            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin: 10px auto;width:540px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 20px;">
							...
							<p style="font-size:16px;line-height:24px;font-weight:bold;padding:0px;margin:20px 0px">{{__('inpanel.mail.invitation.lapsed_content_1')}}</p>
                            
                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;margin:20px 0px">{{__('inpanel.mail.invitation.lapsed_content_2')}}{{$points}} ({{$redeem_request_points}} points) {{__('inpanel.mail.invitation.lapsed_content_3')}} {{__('inpanel.mail.invitation.lapsed_content_4')}}{{$points}} ({{$redeem_request_points}} points) {{__('inpanel.mail.invitation.lapsed_content_5')}}</p>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;padding:10px!important;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin:auto;width:560px;height:129px;background-color:rgba(255, 251, 243, 1); border-radius:13px;padding: 10px 10px; text-align: center;">
                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;margin:20px 0px">{{__('inpanel.mail.invitation.lapsed_content_6')}}</p>
                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;margin:20px 0px">{{str_replace('"','',__('inpanel.mail.invitation.lapsed_content_7'))}}</p>
                        </div>
                    </td>
                </tr>
