    ...
    <div style="margin: 20px auto;width: 600px;">
        ...
        <table style="width: 600px;border-collapse: collapse;margin: 0px;">
            <tbody>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);padding-bottom:20px;">
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;">
                            <img src="{{asset('img/img_email/Redemption_2.png')}}" alt="" style="height:81px;width:81px;margin-top:30px;margin-bottom:0px;">
                            <p style="font-size:30px;line-height:24px;font-weight:bold;padding:0px;">{{__('inpanel.mail.invitation.invite_freind_content_1')}} {{decrypt($user->first_name)}},</p>

                             <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;margin:20px 0px;text-align:center"> {{__('inpanel.mail.invitation.rybbon_notify_content_1')}}</p> 
        
                             <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;margin:20px 0px;text-align:center">{!!__('inpanel.mail.invitation.rybbon_notify_content_2')!!}</p>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;padding:20px!important;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin:auto;width:560px;height:89px;background-color:rgba(255, 251, 243, 1); border-radius:13px;padding: 20px 10px; text-align: center;">
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px; margin-top:20px">{{__('inpanel.mail.invitation.rybbon_notify_content_3')}}</p> 
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="text-align:center;width: 600px; border: 1px solid rgba(233, 233, 233, 1);margin-bottom:30px!important;">
                                ...
                                <table style="width:580px;background-color:white; text-align:center;padding:auto;margin-top:20px!important;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if(isset($user->email))
                                            <a style="font-size:12px;padding:4px; color:black;" href="{{\Illuminate\Support\Facades\URL::signedRoute('inpanel.mail.unsubscribe', ['email' => decrypt($user->email)])}}">{{__('strings.emails.auth.confirmation.unsubscribe')}}</a> 
                                            @else
