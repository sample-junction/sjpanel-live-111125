                ...
                <form  method="post" action="{{route('inpanel.user.profile.preference.update','basic-profile')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            @php
                                $genderText = auth()->user()->gender === 'Male'
                                    ? __('inpanel.user.profile.preferences.preferences_menu.basic_profile_gender_male')
                                    : (auth()->user()->gender === 'Female'
                                        ? __('inpanel.user.profile.preferences.preferences_menu.basic_profile_gender_female')
                                        : '');
                            @endphp                                           
                            <input type="text" id="gender" name="gender" class="form-control" style="font-weight: 600;background: #f9f9f9;" value="{{$genderText}}" readonly>
                        </div>
                    </div>
                    <div class="row pt-md-4">
                        <div class="col-md-4 col-12" style="position: relative;">
                            ...
                            <input type="text" id="dob" name="dob" class="form-control" style="font-weight: 600;background: #f9f9f9;" value="{{(!empty(auth()->user()->dob))?auth()->user()->dob->format('m-d-Y'):''}}" readonly>
