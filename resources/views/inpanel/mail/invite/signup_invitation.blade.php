                ...
                <tr>
                    ...
                    @endphp
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;">
                            <img src="{{asset('img/img_email/refer.png')}}" alt="" style="height:81px;width:81px;margin-top:30px;margin-bottom:10px;">
                            ...
                            @if($currencies['lang']=='IN')
                                <p style="color:rgba(89, 89, 89, 1); font-size:15px;padding:0px 20px;line-height:28px;margin-top:20px;">{{__('inpanel.mail.invitation.signup_invite_content_1')}} {{$referredName}} {{__('inpanel.mail.invitation.signup_invite_content_2')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.signup_invite_content_3')}}{{$points}} ({{$get_referal_point}} {{__('inpanel.dashboard.points')}}) {{__('inpanel.mail.invitation.signup_invite_content_4')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.signup_invite_content_5')}}</p>
                            @else
                                <p style="color:rgba(89, 89, 89, 1); font-size:15px;padding:0px 20px;line-height:28px;margin-top:20px;">{{__('inpanel.mail.invitation.signup_invite_content_1')}} {{$referredName}} {{__('inpanel.mail.invitation.signup_invite_content_2')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.signup_invite_content_3')}}{{$points}} ({{$get_referal_point}} {{__('inpanel.dashboard.points')}}) {{__('inpanel.mail.invitation.signup_invite_content_4')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.signup_invite_content_5')}}</p>
                            @endif
                            
                             <p style="color:rgba(89, 89, 89, 1); font-size:15px;padding:0px 20px;line-height:28px;margin-top:10px;"> {{__('inpanel.mail.invitation.signup_invite_content_6')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.signup_invite_content_7')}} </p> 
                        </div>
                    </td>
                </tr>
                ...
                <!-- <tr>
                    <td style="text-align:center;width: 600px;padding: -20px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin:auto;width:560px;height:89px;background-color:rgba(255, 251, 243, 1); border-radius:13px;padding: 20px 10px; text-align: center;">
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px; margin-top:20px">{{__('inpanel.mail.invitation.signup_invite_content_8')}} <a style="color:rgba(0, 107, 222, 1);" href="{{route('frontend.cms.referral_policy')}}">{{__('inpanel.mail.invitation.signup_invite_content_9')}}</a> {{__('inpanel.mail.invitation.signup_invite_content_10')}}</p> 
                        </div>
                    </td>
                </tr> -->
