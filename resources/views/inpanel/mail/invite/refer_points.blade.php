    ...
    <div style="margin: 20px auto;width: 600px;">
        ...
        <table style="width: 600px;border-collapse: collapse;margin: 0px;">
            <tbody>
                ...
                <tr>
                    ...
                    @php 
                        /* if($currencies['lang']!='UK'){
                            ...
                            if($get_referal_points < 1){
                                ...
                                $points = $currencies['currency_logo']. number_format($get_referal_point,2);
                            }
                        } */
                    ...
                    @endphp
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;">
                            <img src="{{asset('img/img_email/Points.png')}}" alt="" style="height:81px;width:81px;margin-top:20px;margin-bottom:0px;">
                            <p style="font-size:30px;line-height:24px;font-weight:bold;padding:0px;margin-top:20px;">{{__('inpanel.mail.invitation.invite_freind_content_1')}} {{$user->first_name}},</p>

                            <p style="color:rgba(89, 89, 89, 1); font-size:15px;padding:0px 20px;justify-content:center;line-height:28px;margin-top:20px;margin-bottom:10px;"> {{__('inpanel.mail.invitation.refer_point_content_1')}}{{$referredName}}, {{__('inpanel.mail.invitation.refer_point_content_2')}}</p> 
                        @if(@$locale=='hi_IN')
                        <p style="color:rgba(89, 89, 89, 1); font-size:15px;padding:0px 20px;justify-content:center;line-height:28px;margin-bottom:20px;">{{__('inpanel.mail.invitation.refer_point_content_3')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.refer_point_content_4')}}{{$points}} ({{$get_referal_point}} {{__('inpanel.dashboard.points')}}) {{__('inpanel.mail.invitation.refer_point_content_5')}}</a></p>
                        @else
                        <p style="color:rgba(89, 89, 89, 1); font-size:15px;padding:0px 20px;justify-content:center;line-height:28px;margin-bottom:20px;">{{__('inpanel.mail.invitation.refer_point_content_3')}} {{$referred_first_name}} {{__('inpanel.mail.invitation.refer_point_content_4')}}{{$points}} ({{$get_referal_point}} {{__('inpanel.dashboard.points')}}) </a></p>
                        @endif
                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                            <div style="margin:auto;width:560px;height:70px;background-color:rgba(255, 251, 243, 1); border-radius:13px; text-align: center;padding:0px 10px;">
                             <p style="color:rgba(89, 89, 89, 1); font-size:15px;line-height:24px;padding:20px 10px;">{{__('inpanel.mail.invitation.reference_point_content_5')}}</p> 
                        </div>
                    </td>
                </tr>
