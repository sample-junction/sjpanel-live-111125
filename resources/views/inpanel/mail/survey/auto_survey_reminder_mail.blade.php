            ...
            <tbody>
                 <tr>
                    <td style="text-align: center;border:1px solid rgba(233, 233, 233, 1);">
                        <p style="font-size:14px,font-weight:bold;">{{__('inpanel.mail.invitation.device_before_content')}} <span style="font-size:15px,font-weight:bold;">{{$device}}</span></p>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;border:1px solid rgba(233, 233, 233, 1);">
                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;">
                            <img src="{{asset('img/inpanel/email-notification.png')}}" alt="" style="height:81px;width:81px;margin-top:30px;">

                            <p style="font-size:30px;line-height:24px;font-weight:bold;margin-top:20px;"> {{__('inpanel.mail.survey.salutation')}} {{$referralName}},</p><br>

                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;">{{__('inpanel.mail.survey.reminderdetails_1',['survey_num' => $user->apace_project_code])}}</p> 

                        
                                <div style="width:528px;height:153px;margin:40px auto;background-color:rgba(255, 255, 255, 1); border-radius:13px; text-align:center; padding-top:10px;">
                                    <div style="width:245px;">
                                    <p style="font-size:14px;font-weight:bold;background-color:rgba(242, 242, 242, 1);padding:5px; margin-left:px;"> {{__('inpanel.mail.survey.label_1')}}: {{$user->apace_project_code}}</p>
                                    </div>
                                    ...
                                    <table style="margin-left:13px;border-collapse:collapse;">
                                        <thead style="border-bottom:2px solid rgba(236, 236, 236, 1);">
                                            <tr>
                                                <th style="padding:5px 25px;border-bottom:2px solid rgba(236, 236, 236, 1);color:rgba(0, 90, 154, 1);font-size:14px;">{{__('inpanel.mail.survey.label_4')}}</th>
                                                <th style="padding:5px 25px;border-bottom:2px solid rgba(236, 236, 236, 1);color:rgba(0, 90, 154, 1);font-size:14px;">{{__('inpanel.mail.survey.label_2')}}</th>
                                                <th style="padding:5px 25px;border-bottom:2px solid rgba(236, 236, 236, 1);color:rgba(0, 90, 154, 1);font-size:14px;">{{__('inpanel.mail.survey.label_3')}}</th>
                                                <!--<th style="padding:5px 25px;border-bottom:2px solid rgba(236, 236, 236, 1);color:rgba(0, 90, 154, 1);font-size:14px;">{{ __('inpanel.mail.survey.value')}} ($)</th>-->
												<th style="padding:5px 25px;border-bottom:2px solid rgba(236, 236, 236, 1);color:rgba(0, 90, 154, 1);font-size:14px;">{{$currencySymbol}}</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size:14px;padding:10px; color:rgba(0, 0, 0, 1);">{{$loi}} {{__("strings.emails.auth.confirmation.Minutes")}}</td>
                                                ...
                                                <td style="font-size:14px;padding:10px; color:rgba(0, 0, 0, 1);">{{$conversion}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </div>
                            ...
                            <p style="color:rgba(89, 89, 89, 1); font-size:16px; padding-top:0px; margin-bottom:10px">{{__('inpanel.mail.survey.details_5')}} "{{__('strings.emails.auth.confirmation.rewards')}}" {{__('inpanel.mail.survey.details_4')}} </p> 
                            <br>
                           
                            <a href="{{$s_link}}" target="_blank" style="width:308px; height:45px;background-color:rgba(16, 128, 208, 1);border-radius:5px;text-decoration:none;font-size:16px;line-height:40px;color:white;font-weight:bold;padding:13px 70px;">{{ __('inpanel.mail.survey.button')}}</a><br>

                          <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:24px; justify-content:center;width:auto;margin-top:30px!important; margin-bottom:10px;">{{__('inpanel.mail.survey.link_text')}} "{{__("strings.emails.auth.confirmation.Enter")}}": </p> 
