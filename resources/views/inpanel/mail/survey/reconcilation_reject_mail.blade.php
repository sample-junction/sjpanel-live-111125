                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;">
                           ...
                           <img src="{{asset('img/img_email/Blacklisted.png')}}" alt="" style="height:81px;width:81px;margin-top:30px;">

                            <p style="font-size:30px;line-height:24px;font-weight:bold;margin-top:20px;"> {{__('inpanel.mail.survey.salutation')}} {{$user_first_name}},</p><br>

                            <p style="color:rgba(89, 89, 89, 1); font-size:16px; padding-top:0px; margin-bottom:10px;">{{__('inpanel.activity_log.rejection_mail_content1')}}</p> 

                        
                            <div style="width:528px;height:auto;margin:40px auto;background-color:rgba(255, 255, 255, 1); border-radius:13px;padding-top:5px;">
                                    <div style="width:50%;text-align:left;">
                                    <p style="font-size:14px;font-weight:bold;background-color:rgba(242, 242, 242, 1);padding:5px; margin-left:px;"> {{__('inpanel.mail.survey.label_1')}}: {{$project->apace_project_code}}</p>
                                    </div>
                                    ...
                                    <table style="margin-left:13px;border-collapse:collapse;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="font-size:14px;padding:10px; color:rgba(0, 0, 0, 1);">{{$topic_name}}</td>
                                                <td style="font-size:14px;padding:10px; color:rgba(0, 0, 0, 1);">{{$loi}} {{__("strings.emails.auth.confirmation.Minutes")}}</td>
                                                <td style="font-size:14px;padding:10px; color:rgba(0, 0, 0, 1);">{{$project->points}}</td>
                                                <td style="font-size:14px;padding:10px; color:rgba(0, 0, 0, 1);">{{$project->cpi}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </div>
                            ...
                            <p style="color:rgba(89, 89, 89, 1); font-size:16px; padding-top:0px; margin-bottom:10px;">{{__('inpanel.activity_log.rejection_mail_content2')}}</p> 
                            <br>

                            <p style="color:rgba(89, 89, 89, 1); font-size:16px; padding-top:0px; margin-bottom:10px;">{{__('inpanel.activity_log.rejection_mail_content3')}} <a style="text-decoration: none;" href = "mailto:support@sjpanel.com"> {{__('support@sjpanel.com')}}</a>. </p> 
