...
<body style="background-color:white; font-family: 'Roboto', sans-serif;">
    ...
    <!-- Body_part_1 -->
    <div style="width:560px;height:410px;margin:30px auto;background-color:rgba(244, 250, 255, 1); border-radius:13px; text-align:center;">
        <img src="{{asset('img/email_temp/support.png')}}" alt="" style="height:81px;width:81px;margin-top:30px;margin-bottom:20px;"><br>
        <p style="font-size:30px;line-height:20px;font-weight:bold;padding:0px; margin-bottom:10px; padding-bottom:10px;"> {{__('strings.emails.auth.confirmation.dear')}} {{$user->first_name}},</p>
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; padding-left: 30px; padding-right: 30px; padding-bottom:10px;"> {{__('inpanel.Panelist_Support_Mail.content_3')}}</p>        
        <p style="color:rgba(89, 89, 89, 1); font-size:16px; padding-left: 30px; padding-right: 30px; margin-bottom:10px;"> {{__('inpanel.Panelist_Support_Mail.content_4')}}</p> 
