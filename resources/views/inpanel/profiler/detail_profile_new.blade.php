    ...
    <div class="row mt-3 mb-2 ms-lg-2 me-lg-2">
        ...
        <div class="col-12 col-lg-6 mt-2 mt-lg-0" style="background: #246efd;">
            ...
            <div class="row ps-2 pe-2 ps-lg-0 pe-lg-0 pt-3 pb-3">
                <div class="col-12 col-lg-6 text-lg-center pt-2 pb-3 pb-lg-0  earned-points">
                ...
                <div class="col-12 col-lg-6 text-lg-center pt-2 pb-3 pb-lg-0 remaining-points">
    ...
    $(document).ready(function() {
        ...
        function processDependencies($select, ques_code, currentValue) {
            ...
            dep_ques.forEach(function(ques) {
                ...
                if (typeof ques.dependency === "string") {
                    try {
                        let parsed = JSON.parse(ques.dependency || "[]");
                        dep_jsonObj = Array.isArray(parsed) ? parsed : [];
                    } catch (e) {
                        dep_jsonObj = [];
                    }
                } else if (typeof ques.dependency === "object" && ques.dependency !== null) {
                    dep_jsonObj = Array.isArray(ques.dependency) ? ques.dependency : [];
                }
