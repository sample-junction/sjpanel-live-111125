...
<link href="{{asset('css2/dashboard_style.css')}}" rel="stylesheet">
 ...
 <!-- data table -->
    ...
    position: absolute;
        ...
        /* code added by Anil */
#surveyCountryMismatchModal .welcome-content {
    display: flex;
...
#surveyCountryMismatchModal .welcome-paragraph {
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
...
#surveyCountryMismatchModal .welcome-paragraph p{
    font-weight: 400;
    font-size: 18px;
    line-height: 16px;
}
#surveyCountryMismatchModal .welcome-content .welcome-span {
    color: #0d7bf0;
    font-weight: bold;
    font-size: 30px;
...
#surveyCountryMismatchModal .modal-header {
  border-bottom: none !important;
  border-bottom: unset !important;
}

#surveyCountryMismatchModal .custom-close {
...
#surveyCountryMismatchModal .custom-close::before,
#surveyCountryMismatchModal .custom-close::after {
    background-color: white !important;
}


#surveyCountryMismatchModal .modal-content .custom-button{
...
#surveyCountryMismatchModal .welcome-div {
    display: flex;
    flex-direction: column;
    gap: 1rem;
}
#surveyCountryMismatchModal .modal-popup-other-country{
    max-height: 330px!important;
}
@media only screen and (max-width: 991px) {
  #surveyCountryMismatchModal .modal-body{
...
<!-- <div class="col-sm-12 col-xl-10 border-start pe-4 ps-4" style="background: #F5F5F5; overflow:hidden"> -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col text-end">
                                                            <a class="btn btn-primary btn-lg survey-btn" style="font-size: 17px;"
                                                                href="{{ route('inpanel.survey.execute.show', ['survey_id' => $availableSurvey->id]) }}"
                                                                target="_blank">
    ...
    <!-- Ending -->
     <!-- Code added by Anil -->
          <div class="modal fade" id="surveyCountryMismatchModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="surveyCountryMismatchModalToggle"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="surveyCountryMismatchModalToggle"></h1>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 welcome-div">
                                ...
                                <div class="">
                                    <button class="custom-button" id="countryMismatchOkBtn" data-bs-dismiss="modal">{{ __('inpanel.login_country_warning.ok') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $('#table_id_sh')
      ...
      .DataTable({        "language": {
        ...
        $('#table_id_sh').on('page.dt', function() {
            $('html, body').animate({
                scrollTop: $("#table_id_sh").offset().top - 300
            }, 400);
        });
  });
  ...
  .ready(function () {
    $('#table_id_shh')
      .DataTable({        "language": {
        ...
        $('#table_id_shh').on('page.dt', function() {
            $('html, body').animate({
                scrollTop: $("#table_id_shh").offset().top - 300
            }, 400);
        });
  });
                            ...
                            document.querySelector('#hot_survey_section').innerHTML = "";
                                for(let i = 0; i < mergeResult.length; i++){
                                    ...
                                    for(let i = 0; i < te.length; i++){
                                        ...
                                        var url = "{{route('inpanel.survey.execute.show', ['survey_id' => ':id'])}}";
