                    ...
                    <div class="shadow border rounded pe-4 ps-4 pt-3" style="background: #FFFFFF;">
                        ...
                        <div class="col-12 mt-4 mb-4">
                                ...
                                <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 10px;">
                                    <div class="progress-bar bg-success"  @if(auth()->user()->is_social==1 && !session()->has('is_social'))  @if(session()->get('country_update')==1)style="width: 33%" @endif @else style="width: 50%" @endif></div>
                                </div>
                         ...
                         <div class="row pt-md-4 page_language" @if(session()->get('country_update')==1) style="display:none;" @endif>
                            ...
                            <div class="row" style="margin-left: 0px;">
                                         ...
                                         <div class="row1" id="english1" style="margin-left: 0px;">
                                           ...
                                           <input type="radio" name="enanswer" id="enanswer" 
                                           class="chk" value="en_US" @if(auth()->user()->locale=="en_US") checked @endif; 
                                           onclick="showoption(this.value)" /><label for="">&nbsp;English/Inglés 
                                            </label></div>
                             ...
                             <div class="col-md-4 col-12">
                                          ...
                                          <!-- modified by obhi -->
                                            @php
                                                ...
                                                $data = ($domain ==="samplejunction.com") ? "" :$email;
                                            @endphp
                                            <input type="text" name="email_new" id="email_new" class="form-control @if(auth()->user()->email=='') emsg @endif;" value="{{$data}}" >
                                             <!-- modified by obhi -->


                                          <input type="hidden" name="email" id="email" class="form-control @if(auth()->user()->email=='') emsg @endif;" value="{{$email}}" >
                                        </div>
                                        <div class="col-md-4 col-12">
                                        ...
                                        <div class="col-md-4 col-12 " style="position: relative;">
                                          ...
                                          <input class="form-control date_div  @if(auth()->user()->dob=='') emsg @endif"
                                            type="text" placeholder="MM/DD/YYYY" name="dob_v1" id="dob_v1" style="background: white;cursor: pointer;width: 100%;border-radius: 6px;font-weight: 600;"
                                ...
                                <div class="col-md-4 col-12">
                                  <label for="zipcode" class="control-label col-sm-2 col-md-4">
                                    ...
                                    <input id="zipcode" name="zipcode" value="{{auth()->user()->zipcode}}" type="text" class="form-control @if(auth()->user()->zipcode=='') emsg @endif;">
                                    ...
                                    <form id="partial-update" method="post" action="{{url('basic-detail-update')}}">
                                        ...
                                        <!-- Modified by obhi -->
                                        <input type="hidden" id="user_email2" name="social_email" value="">
                                        <!-- Modified by obhi -->
                            ...
                            <div class="row mt-4 mb-4 device" @if(auth()->user()->is_social==1 && !session()->has('is_social'))style="display:none;" @endif >
                                ...
                                <div class="col-sm-12 col-md-4 mb-4 mb-md-0">
                                    ...
                                    <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                                        ...
                                        {!! BootForm::checkbox('device_preference[]', __('inpanel.user.profile.preferences.preferences_menu.desktop_laptop'), '2', ((in_array('2',(explode(',', auth()->user()->device_preference)))))? true : false ,array('class'=>'all_preference chk','onclick'=>'checkDevice(this,"1")')); !!}
                                ...
                                <div class="col-sm-12 col-md-4 mb-4 mb-md-0">
                                    ...
                                    <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                                        ...
                                        {!! BootForm::checkbox('device_preference[]',__('inpanel.user.profile.preferences.preferences_menu.mobile_phone'), '3', ((in_array('3',(explode(',', auth()->user()->device_preference)))))? true : false ,array('class'=>'all_preference chk','onclick'=>'checkDevice(this,"1")')); !!}
                                ...
                                <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                                        ...
                                        {!! BootForm::checkbox('device_preference[]',__('inpanel.user.profile.preferences.preferences_menu.tablet'), '4', ((in_array('4',(explode(',', auth()->user()->device_preference)))))? true : false ,array('class'=>'all_preference chk','onclick'=>'checkDevice(this,"1")')); !!}
                            ...
                            <div class="row mb-4 device1"  @if(auth()->user()->is_social==1 && !session()->has('is_social'))style="display:none;" @endif >
                                ...
                                <div class="col-sm-12 col-md-4 device1" >
                                    ...
                                    <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                                        ...
                                        {!! BootForm::checkbox('device_preference[]',__('inpanel.user.profile.preferences.preferences_menu.all'), '1', ((in_array('1',(explode(',', auth()->user()->device_preference)))))? true : false ,array('class'=>'alldevice chk','onclick'=>'checkDevice(this,"1")')); !!}
...
@push('after-scripts')
 ...
 <script type="text/javascript" id="forensic_script_id" src="https://api-cdn.dfiq.net/scripts/forensic-v5.1.0.min.js" data-key="29109E607D0B6E11DE0B966F50EA617A-5004-1" data-nc></script>
    ...
    <script>
            ...
            //modified by obhi
                $(document).ready(function(){
                    $('.input_email_new').on('click', function () {
                ...
                if (parts.length === 2) {
                    ...
                    if (domain === 'samplejunction.com') {
                        $('#user_email2').val(email_new);
                    } else {
                        $('#user_email2').val('');
                    }}});
                });
