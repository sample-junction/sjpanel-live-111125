            ...
            <div class="col-sm-12 col-md-4 mb-4 mb-md-0">
                ...
                <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                    ...
                    {{--<input type="checkbox" name="device" value="Desktop/Laptop" id="deviceOne" class="chk"><label for="deviceOne" class="ms-2">Desktop/Laptop</label>--}}
                        <input type="checkbox" name="device_preference[]" value="2" 
                            @if(in_array('2', explode(',', auth()->user()->device_preference))) checked @endif
                            class="all_preference chk chkbox form-check-input"
                            onclick="checkDevice(this)"
                            onchange="updateSubmitBtn()">
                        <label class="form-check-label ms-2">{!! __('inpanel.user.profile.preferences.preferences_menu.desktop_laptop') !!}</label>
                </div>
            ...
            <div class="col-sm-12 col-md-4 mb-4 mb-md-0">
                ...
                <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                    ...
                    {{--<input type="checkbox" name="device" value="Mobile/Phone" id="deviceTwo" class="chk"><label for="deviceTwo" class="ms-2">Mobile/Phone</label>--}}
                        <input type="checkbox" name="device_preference[]" value="3"
                            @if(in_array('3', explode(',', auth()->user()->device_preference))) checked @endif
                            class="all_preference chk chkbox form-check-input"
                            onclick="checkDevice(this)"
                            onchange="updateSubmitBtn()">
                        <label class="form-check-label ms-2">{!! __('inpanel.user.profile.preferences.preferences_menu.mobile_phone') !!}</label>
                </div>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                    ...
                    {{--<input type="checkbox" name="device" value="Tablet" id="deviceThree" class="chk"><label for="deviceThree" class="ms-2">Tablet</label>--}}
                        <input type="checkbox" name="device_preference[]" value="4"
                            @if(in_array('4', explode(',', auth()->user()->device_preference))) checked @endif
                            class="all_preference chk chkbox form-check-input"
                            onclick="checkDevice(this)"
                            onchange="updateSubmitBtn()">
                        <label class="form-check-label ms-2">{!! __('inpanel.user.profile.preferences.preferences_menu.tablet') !!}</label>
                </div>
            ...
            <div class="col-sm-12 col-md-4 device1">
                ...
                <div class="border p-3" style="background: #F3F3F3; border: 1px solid #ECECEC; border-radius: 5px;">
                    ...
                    {{--<input type="checkbox" name="device" value="All" id="deviceFour" class="chk"><label for="deviceFour" class="ms-2">All</label>--}}
                        <input type="checkbox" name="device_preference[]" value="1"
                            @if(in_array('1', explode(',', auth()->user()->device_preference))) checked @endif
                            class="alldevice chk chkbox form-check-input"
                            onclick="checkDevice(this)"
                            onchange="updateSubmitBtn()">
                        <label class="form-check-label ms-2">{!! __('inpanel.user.profile.preferences.preferences_menu.all') !!}</label>
