            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;text-align:center;">
                            <img src="{{asset('img/img_email/Blacklisted.png')}}" alt="" style="height:81px;width:81px;margin-top:30px;margin-bottom:5px;">
                            <p style="font-size:30px;line-height:24px;font-weight:bold;padding:0px;margin-top:5px;margin-top:20px;">{{__('inpanel.mail.invitation.invite_freind_content_1')}} {{$user->first_name}},</p>

                            @php
                                $survey_number='';
                                $i=1;
                                $count=count($fraud_survey_data);
                                foreach($fraud_survey_data as $index=>$value){
                                    $survey_number .=$value;
                                    if($i<$count){
                                        $survey_number .=', ';
                                    }else{
                            ...
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px;text-align:center;line-height:28px;margin-bottom:30px;margin-top:30px;"> {{__('inpanel.mail.invitation.blacklist_mail_content_1')}} {{$survey_number}} </p> 
        
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px;text-align:center;line-height:28px;margin-bottom:20px;">{{__('inpanel.mail.invitation.blacklist_mail_content_2')}} <a style="color:blue;text-decoration:none;" href="{{route('frontend.cms.rewards_policy')}}">{{__('inpanel.mail.invitation.blacklist_mail_content_3')}}</a></p>
                ...
                <tr>
                    <td style="text-align:center;width: 600px;height:auto;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin:auto;width:560px;height:auto;background-color:rgba(255, 251, 243, 1); border-radius:13px;padding: 20px 10px; text-align: center;">
                            <p style="color:rgba(89, 89, 89, 1); font-size:15px;line-height:24px;justify-content:center;">{{__('inpanel.mail.invitation.blacklist_mail_content_4')}} <a href="mailto:support@sjpanel.com" style="text-decoration:none;">support@sjpanel.com</a>{{__('inpanel.mail.invitation.blacklist_mail_content_5')}}</p> 
                        </div>
                    </td>
                </tr>
