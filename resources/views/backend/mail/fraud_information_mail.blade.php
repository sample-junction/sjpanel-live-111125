                ...
                <tr>
                    <td style="text-align:center;width: 600px;border-left:1px solid rgba(233, 233, 233, 1);border-right:1px solid rgba(233, 233, 233, 1);">
                        <div style="margin: 20px auto;width:560px;background-color:rgba(244, 250, 255, 1); border-radius:13px;padding:10px 10px;">
                            ...
                            <p style="font-size:30px;line-height:24px;font-weight:bold;margin-top:20px;">{{__('inpanel.mail.invitation.invite_freind_content_1')}} {{$user->first_name}},</p>

                            <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:27px;justify-content:center;margin-top:30px!important;margin-bottom:30px!important;width:auto;"> {{__('inpanel.mail.invitation.fraud_info_mail_content_1')}} {{$survey_id}} {{__('inpanel.mail.invitation.fraud_info_mail_content_2')}} </p> 
        
                             <p style="color:rgba(89, 89, 89, 1); font-size:16px;line-height:27px;justify-content:center;margin-top:30px!important;margin-bottom:30px!important;width:auto;">{{__('inpanel.mail.invitation.fraud_info_mail_content_3')}} <a style="color:blue;text-decoration:none;" href="{{route('frontend.cms.rewards_policy')}}">{{__('inpanel.mail.invitation.fraud_info_mail_content_4')}}</a> {{__('inpanel.mail.invitation.fraud_info_mail_content_5')}}</p> 
                        </div>
                    </td>
                </tr>
