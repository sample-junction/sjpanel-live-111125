            ...
            <div class="row">
                <table class="table table-striped table-hover" id="campaign_history" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th>@lang('inpanel.nav.label.Campaign_Amount')(cpi (Points))</th>
                        <th>Survey Loi</th>
                        <th>Survey Topic</th>
                        <th>Campaign Template</th>
                        <th>Campaign Mail Send</th>
                        <th>Survey Email Reminder</th>
                        <th>Email Reminder Date</th>
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->survey_email_reminder}}</td>
                                    <td>{{$data->email_reminder_date}}</td>
