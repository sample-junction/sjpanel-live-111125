        ...
        <div class="card-header">
            <div class="row">
                <div class="col-sm-10">
                    ...
                    <center><label>
                        <h4>
                            Edit And Create Clone Survey Reminder
                        </h4>
                    </label>
                </center>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    @endphp
                    <form action="{{route('admin.auth.update-clone-survey-reminder')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group mt-2">
                        <label for=""><h5>Survey Reminder Name :</h5></label>
                        <input type="text" class="form-control" value="" name="campaign_name" placeholder="Enter the Survey Reminder Name">
                    </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="campaign_subject" class="form-control" value="{{$data->campaign_subject}}">
                    </div>

                    <div class="form-group mt-2">
                        <label for=""><h5>Status :</h5></label>
                        <select name="campaign_status" id="" class="form-select" aria-label="Default select example">
                        <option value="{{$data->campaign_status}}" >Active</option>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea name="campaign_content" class="content" id="email_content" cols="60" rows="1000" style="">
