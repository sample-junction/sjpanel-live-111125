        ...
        <div class="card-header">
            <div class="row">
                <div class="col-sm-10">
                    ...
                    <center><label>
                        <h4>
                            Edit And Update Survey Reminder
                        </h4>
                    </label></center>
                </div>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    @endphp
                    <form action="{{route('admin.auth.update-survey-reminder')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                    <div class="form-group mt-2">
                        <label for=""><h5>Survey Reminder Name :</h5></label>
                        <input type="text" class="form-control" value="{{$data->campaign_name}}" name="campaign_name">
                    </div>
