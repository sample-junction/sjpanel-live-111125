            ...
            <div class="row">
                <div class="col-12">
                   ...
                   @foreach($datas as $data)
                      ...
                      @endphp
                    <form action="{{route('admin.auth.update-campaign')}}" method="POST">
                        @csrf

                        <div class="form-group mt-2">
                            <label for=""><h4>Campaign Name :</h4></label>
                            <input type="text" name="campaign_name" class="form-control" placeholder="Enter Template Name" value="{{$data->campaign_name}}">
                      </div>
                    ...
                    @php
                        $content = str_replace('#YEAR', date('Y'), $data->campaign_content);
                    @endphp
                    <div class="form-group mt-2">
                        <label for=""><h4>Template Body Content :</h4></label>
                        <textarea name="campaign_content" class="content" id="email_content" cols="60" rows="60">{!! $content !!}</textarea>
                    </div>
