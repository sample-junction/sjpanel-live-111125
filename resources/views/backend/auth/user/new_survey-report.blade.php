...
@section('title', app_name() . ' | ' . __('labels.backend.access.reports.titles.new_survey_report'))
        ...
        <div class="row">
           ...
           <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    Reports <small class="text-muted">Survey Report</small>
                </h4>
            </div><!--col-->
            <!-- <div class="col-sm-7">
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table" id="user_management">
                        ...
                        @foreach($survey_report as $result)

                        @if(count($survey_report) > 0)
                            <tr>
                                 <td  class="text-center">{{ $result->apace_project_code }}</td>
                                 ...
                                 <td  class="text-center">
                                    @php
                                      ...
                                      if($result->survey_status_code == 'CLOSED'){
