        ...
        <div class="card-header">
            <div class="row">
                <div class="col-sm-10">
                    <label>
                        <h4>
                        {{__('frontend.register.unsubscribe.table')}}
        ...
        <div class="card-body">
            ...
            <div class="row">
                <table class="table table-striped table-hover" id="campaign_history" style="width:100%">
                    ...
                    <tbody>
                                @foreach($Unsubscribe as $Unsubscribes )
                                <tr>
                            <td>{{$Unsubscribes['panellist_id']}}</td>
                                    <td>{{$Unsubscribes['reason']}}</td>
                                    <td>{{$Unsubscribes['otherReason']}}</td>
                                    <td>{{ $Unsubscribes['created_at']}}</td>
                                </tr>
                               @endforeach
                    </tbody>
                </table>
