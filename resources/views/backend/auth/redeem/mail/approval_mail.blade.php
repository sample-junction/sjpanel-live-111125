            ...
            <div style="background-color:transparent;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <![endif]-->
                        <!--[if (mso)|(IE)]>
                        <td align="center" width="500" style=" width:500px; padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:15px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top">
                        <![endif]-->
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:15px; padding-right: 0px; padding-left: 0px;">
                                        ...
                                        <div style="color:#00d2b9;font-family:Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;font-family:Georgia, Times, 'Times New Roman', serif;color:#00d2b9;text-align:left;">
                                                <div style="border-bottom: 1px solid #cacaca;">
                                                    <img src="https://sjpanel.com/images/logo.png" width="150px" height="40px" style="text-align: center;align: center;" align="center">
                                                </div>
                                            </div>
                                        </div>
                                        <!--[if mso]>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#00d2b9;font-family:Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;font-family:Georgia, Times, 'Times New Roman', serif;color:#00d2b9;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 38px; line-height: 45px;"><span style="line-height: 45px; font-size: 38px;">You Are</span></span></p>
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><em><span style="color: rgb(85, 85, 85); font-size: 80px; line-height: 96px;"><span style="line-height: 96px; font-size: 80px;"><span style="line-height: 96px; font-size: 80px;">Invited!</span></span></span></em></p>
                                            </div>
                                        </div>
                                        <!--[if mso]>
                                        </td>
                                    ...
                                    <div class="">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding-right: 30px; padding-left: 30px; padding-top: 20px; padding-bottom: 15px;">
                                        <![endif]-->
                                        <div style="color:#555555;font-family:Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 30px; padding-left: 30px; padding-top: 20px; padding-bottom: 15px;">
                                            <div style="font-family:Georgia, Times, 'Times New Roman', serif;font-size:12px;line-height:14px;color:#555555;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><em><span style="font-size: 34px; line-height: 40px;">Hi {{$user->first_name}},</span></em></p>
                                            </div>
                                        </div>
                                        <!--[if mso]>
                                        </td>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#555555;font-family:Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 30px; padding-left: 30px; padding-top: 20px; padding-bottom: 15px;">
                                            <div style="font-family:Georgia, Times, 'Times New Roman', serif;font-size:12px;line-height:14px;color:#555555;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><em><span style="font-size: 34px; line-height: 40px;">Your friend {{$user->name}} has referred you</span></em></p>
                                            </div>
                                        </div>
                                        <!--[if mso]>
                                        </td>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#00d2b9;font-family:Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 5px;">
                                            <div style="font-size:12px;line-height:14px;font-family:Georgia, Times, 'Times New Roman', serif;color:#00d2b9;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="font-size: 22px; line-height: 26px;"><span style="line-height: 26px; font-size: 22px;">...to join our online survey panel!</span></span></p>
                                            </div>
                                        </div>
                                        <!--[if mso]>
                                        </td>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#989898;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#989898;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">where you can earn exciting rewards by simply giving your honest opinion on surveys</p>
                                            </div>
                                        </div>
                                        <!--[if mso]>
                                        </td>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                            <tr>
                                                <td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center">
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$user->email}}" style="height:31pt; v-text-anchor:middle; width:145pt;" arcsize="0%" strokecolor="#00d2b9" fillcolor="#00d2b9">
                                                        <w:anchorlock/>
            ...
            <div style="background-color:#00d2b9;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="background-color:#00d2b9;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 500px;">
                                        <tr class="layout-full-width" style="background-color:transparent;">
                        <![endif]-->
                        <!--[if (mso)|(IE)]>
            ...
            <div style="background-color:#F2F8F9;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="background-color:#F2F8F9;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 500px;">
                                        <tr class="layout-full-width" style="background-color:transparent;">
                        <![endif]-->
                        <!--[if (mso)|(IE)]>
                        <td align="center" width="500" style=" width:500px; padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px; border-top: 0px solid #5ACEE1; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top">
                        <![endif]-->
                        <div class="col num12" style="min-width: 320px;max-width: 500px;display: table-cell;vertical-align: top;">
                            <div style="background-color: transparent; width: 100% !important;">
                                <!--[if (!mso)&(!IE)]><!-->
                                        ...
                                        <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                    <strong>&reg; 2018 Sample Junction</strong><br/> <a href="{{route('frontend.cms.privacy')}}">Privacy Policy</a> | <a href="https://samplejunction.com/safeguard/">Safeguards</a> | <a href="{{route('frontend.cms.faq')}}">FAQ</a>
                                                </p>
                                            </div>
                                        </div>
                                        <!--[if mso]>
