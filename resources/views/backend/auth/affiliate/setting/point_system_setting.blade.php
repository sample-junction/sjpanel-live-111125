        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-4 col-md-6 col-sm-12">
                    <div class="row">
                        <div class="col-lg-7 col-md-6 col-sm-12">
                            <label class="control-label"><strong>{{__('Redeemption Threshold')}}:</strong></label>
                        </div>
                        <div class="col-lg-5 col-md-6 col-sm-12">     
                            <input type="text"  name="redeemption_threshold" value="{{ $redeemptionThresholdPoints->value }}" required class="form-control">
                        </div>
                    </div>
                </div>
