					...
					<div class="table-responsive">
						<table class="table" id="emailsSentTable">
							...
							<tbody>
								...
								<td>{{$date}}</td>
								<td>
									<a id="reminderButton" onclick="sendReminder('{{$recentEmailsSentData->batch_number}}')" href="javascript::void()" class="btn btn-primary"><i class="fas fa-paper-plane" title="Send Reminder"></i></a> | <a id="reminderButton" href="{{ route('admin.auth.invite.viewFresh', ['id' => encrypt($recentEmailsSentData->batch_number)]) }}" target="_blank" class="btn btn-primary"><i class="fas fa-eye icon-red" title="View Fresh Invites" style="color: green;"></i></a> | <a id="reminderButton" href="{{ route('admin.auth.invite.viewReminder', ['batch' => encrypt($recentEmailsSentData->batch_number)]) }}" target="_blank" class="btn btn-primary"><i class="fas fa-eye icon-red" title="View Send Reminders" style="color: blue;"></i></a>
								</td>
								</tr>
								@endforeach
							</tbody>
