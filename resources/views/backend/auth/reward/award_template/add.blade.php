...
@section('content')
    ...
    @php
        $default_template_html = view('backend.auth.reward.award_template.default_template_html')->render();
    @endphp
            ...
            <div class="row">
                <div class="col-12">
                    <div style="font-size:30px;">
                        <form action="{{ route('admin.auth.reward.template.add.post') }}" method="POST"
