...
@section('title', __('labels.backend.access.users.management') . ' | Create Award' )
...
<div class="card">
    ...
    {{html()->form('POST',route('admin.auth.awards.create.post'))->open()}}
    <div class="card-body">
        <div class="row">
            <div class="col-sm-3">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Enter Award's Name" value="" name="name">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nominations Start no." value="" name="nomination_start">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nominations End no." value="" name="nomination_end">
                </div>
            </div>
        </div>
        <div class="row">
