...
<div class="contentarea">
        <h3 style="font-size: 14px;">
            We have reached the required number of participants for this survey. 
        </h3>
    ...
    <p style="text-align: center;"><a href="{{ $next_survey_url }}" title="Take Another Survey"><button class="btn btn-primary">Take another survey</button></a></p>
       <p style="text-align:center">
           We will send you more rewarding surveys soon. 
       </p>

        <p style="text-align:center">
           You may also check member dashboard for more matching surveys. 
        </p>
        <p style="text-align:center">
