...
<div class="contentarea">
    <h3 style="font-size: 14px;text-align: center;">Congratulations! You have successfully completed the survey.</h3>
	<p style="padding-bottom:15px; text-align:center;">
        The reward points will be credited once our client has checked and approved your survey responses. 
    </p>
	...
	<p style="padding-bottom:15px; text-align:center">	
	To know more about the rewards procedure, please refer to our <a href="{{url('pages/rewards-policy')}}">rewards policy.</a>
	</p>
	<p style="padding-bottom:15px; text-align:center">
