...
<div class="contentarea">
    <h3 style="font-size: 14px;text-align: center;">You tried attempting the survey using a method that is against our panel quality standards.
    </h3>
   ...
   <ul>
    <li><strong>Attempting the survey which is currently not available.</strong></li>
     <li><strong>Attempting the survey from unregistered email.</strong></li>
      <li><strong>Attempting the survey from a country not matching your profile.</strong></li>
       <li><strong>Attempting the survey from invalid survey link.</strong></li>
        <li><strong>Attempting the survey more than once.</strong></li>
   </ul>
