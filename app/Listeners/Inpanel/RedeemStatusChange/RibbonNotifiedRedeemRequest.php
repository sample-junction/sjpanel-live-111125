...
class RibbonNotifiedRedeemRequest
{
    /**
    ...
    /**
     * Listener to handle the BulkUserRedeemStatusChange Event of Ribbon Notified the Redeem Requests in bulk.
     *
     * @param  object  $event
     * @return void
     */
    public function handle($event)
    {
        ...
        $redeemRepo->ribbonNotified($user,$redeem_id);
    }
}
