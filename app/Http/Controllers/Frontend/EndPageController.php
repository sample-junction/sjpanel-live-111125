				...
				if(count($completed_projects) <= 1){
					...
					if(!empty($referee)){
					    ...
					    $msg_keys = [
                            ...
                            'end'   => 'frontend.notification_txt.referral_rqst_survey_completion'
                        ];
						$this->notificationRepo->createNotification($referee->uuid,'Referral Request',$ref_req_id->referral_link_id,json_encode([
                            'keys' => $msg_keys,
