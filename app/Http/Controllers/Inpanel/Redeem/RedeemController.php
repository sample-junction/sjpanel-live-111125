...
class RedeemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $country = explode('_', $countryPoint->country_language);
        $is_default = 0;
        ...
        return View('inpanel.redeem.new_mypoints')
            ...
            ->with('payment_method_default', $payment_method_default)
    ...
    public function sendRedeemRequest(Request $request)
    {
        ...
        /* *Code Added by Anil */
        $stateToRegionMapping = $this->stateRegion();
        $currencies = array(
        ...
        // insert the code for payment_method
        ...
        $redeemMethod =  'Select from Rybbon reward page';
