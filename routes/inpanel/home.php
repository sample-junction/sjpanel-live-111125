    ...
    Route::group(['middleware' => ['has_basic_detail']], function () {
        ...
        */
        ...
        Route::group([
            ...
            Route::post('redeem/bankDetails', 'RedeemController@bankDetails')->name('redeem.bankDetails');
            Route::post('redeem/bankMethodUpdate', 'RedeemController@bankMethodUpdate')->name('redeem.bankMethodUpdate');
        });
