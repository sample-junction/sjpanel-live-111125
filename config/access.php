...
return [
    ...
    'users' => [
        ...
        'redeem_email' => env('REDEEM_EMAIL',false),
        /*
        ...
        /*
         * The name of the executive_role role
         */
        ...
        'default_role' => 'panelist',
         ...
         /*
         modified by obhi
         * The test panelist role all new registered users get added to
         */
        'test_penalist_role' => 'test panelist',
    ...
    */
    ...
    'registration_geo_ip_check' => env('REGISTRATION_GEO_IP_CHECK', false),
    'basic_details_zip_country_check' =>  env('REGISTRATION_COUNTRY_ZIP_CHECK', false),
];
