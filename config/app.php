...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'SJPANEL '.app()->version().''),
    ...
    */
    ...
    /*
     * Points Related Settings
     * Achievement depicts whether to give these points
     * metrics reflects points conversions
     * */
    'points' => [
        'achievement' => [
            'user_joining' => false,
        ...
        'metric' => [
            'threshold_points' => env('PANEL_THRESHOLD_POINTS', 500),
            'conversion' => env('PANEL_POINTS_CONVERSION_METRIC', 0.001),
        ],
    ],
    ...
    */
    ...
    'aliases' => [
        ...
        'BootForm' => Spatie\Html\Html::class,
